...
$.extend($.ui, { datetimepicker: { version: "1.0.0"} });
    ...
    $.extend(Datetimepicker.prototype, {
        ...
        _updateDatepicker: function(inst) {
            ...
            var timeChangeFunction = function() {
                ...
                inst.currentMonth--;
            	$.datetimepicker._selectDate('#' + inst.id, $.datetimepicker._formatDate(inst, inst.currentDay, inst.currentMonth, inst.currentYear));
            };
            $("#DP_jQuery_Hour_" + dpuuid).change(timeChangeFunction);
            $("#DP_jQuery_Minute_" + dpuuid).change(timeChangeFunction);
            $("#DP_jQuery_AMPM_" + dpuuid).change(timeChangeFunction);
        ...
        _selectDay: function(id, month, year, td, hh, mm, am) {
            ...
            $(td).parent().parent().find('td').removeClass(this._currentClass);
            $(td).addClass(this._currentClass);
            $(td).parent().parent().find('td a').removeClass('ui-state-active');
...
//            }
	   ...
	   @param  format    string - the expected format of the date
        ...
        parseDate: function(format, value, settings) {
            ...
            dte.setYear(this._DetermineYear(Date.prototype.getFullYear ? dte.getFullYear() : (dte.getYear() + 1900)));
