...
!function (a) {
	"use strict";
	var b = function (b, c) {
		this.element = a(b), this.options = a.extend(!0, {}, a.fn.tag.defaults, c), this.values = a.grep(a.map(this.element.val().split(","), a.trim), function (a) {
			return a.length > 0
		}), this.show()
	};
	b.prototype = {
		constructor: b, show: function () {
			...
			b.element.parent().prepend(b.element.detach().hide()), b.element.wrap(a('<div class="tags">')).parent().on("click", function () {
				...
				source: b.options.source, matcher: function (a) {
			...
			var c = this;
			a("<span/>", {"class": "tag"}).text(b.toString()).append(a('<button type="button" class="close">&times;</button>').on("click", function () {
	...
	a.fn.tag = function (c) {
		return this.each(function () {
			var d = a(this), e = d.data("tag"), f = "object" == typeof c && c;
